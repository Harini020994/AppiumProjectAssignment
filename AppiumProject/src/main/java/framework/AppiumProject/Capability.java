...
public class Capability {
	...
	public AppiumDriverLocalService startServer() {
		...
		service=AppiumDriverLocalService.buildService(new AppiumServiceBuilder()
				...
				.withAppiumJS(new File("C:\\Users\\HariniKantheti\\AppData\\Roaming\\npm\\node_modules\\appium\\build\\lib\\main.js"))
	...
	public static void startEmulator() throws IOException, InterruptedException {
		...
		Runtime.getRuntime().exec(System.getProperty("user.dir")+"//src//main//java//emulator1.bat");
		Thread.sleep(10000);
	}
	...
	public static AndroidDriver<AndroidElement> capabilities(String appPackage,String appActivity,String deviceName,String platformName,String chromeExecutable) throws IOException, InterruptedException {
		...
		FileReader fis=new FileReader(System.getProperty("user.dir")+"//src//main//java//gobal.properties");
		...
		if(deviceName.contains("Harini1")) {
			startEmulator();
		}
